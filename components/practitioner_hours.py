...
def render_weekly_hours_editor(assignments_df):
    st.sidebar.markdown("### ⏱️ Weekly Hours per Role per Level")

    # Build state if first time
    ...
    # UI: Group by level and show sliders for each role
